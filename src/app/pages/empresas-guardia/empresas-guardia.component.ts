...
@Component({
  selector: 'app-empresas-guardia',
  templateUrl: './empresas-guardia.component.html',
  styleUrls: ['./empresas-guardia.component.scss']
})
export class EmpresasGuardiaComponent implements OnInit {
