...
@Component({
  selector: 'app-nombrada-admin',
  templateUrl: './nombrada-admin.component.html',
  styleUrls: ['./nombrada-admin.component.scss']
})
export class NombradaAdminComponent implements OnInit {
