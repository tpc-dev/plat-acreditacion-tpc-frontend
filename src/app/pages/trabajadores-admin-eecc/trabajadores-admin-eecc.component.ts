...
@Component({
  selector: 'app-trabajadores-admin-eecc',
  templateUrl: './trabajadores-admin-eecc.component.html',
  styleUrls: ['./trabajadores-admin-eecc.component.scss']
})
export class TrabajadoresAdminEeccComponent implements OnInit {
