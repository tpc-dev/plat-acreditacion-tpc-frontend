...
@Component({
  selector: 'app-vehiculos-admin-eecc',
  templateUrl: './vehiculos-admin-eecc.component.html',
  styleUrls: ['./vehiculos-admin-eecc.component.scss']
})
export class VehiculosAdminEeccComponent implements OnInit {
